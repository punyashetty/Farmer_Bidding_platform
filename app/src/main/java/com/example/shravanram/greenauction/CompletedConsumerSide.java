        ...
        FirebaseRecyclerAdapter<AuctionCardView1,BlogviewHolder>firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<AuctionCardView1,
            ...
            public BlogviewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                ...
                viewHolder.setOnClickListener(new BlogviewHolder.ClickListener() {
                   ...
                   //     Toast.makeText(getApplicationContext(), "Auction clicked : " + c.getText(), Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(getApplicationContext(), "Auction long clicked  " + position, Toast.LENGTH_SHORT).show();
                    }
                });
                return viewHolder;
            }
