...
public class ConsumerViewProfile extends AppCompatActivity {
    ...
    String e1[];
    String nameOfPerson,loca,phoneOfPerson;

    private DatabaseReference mDatabase;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_consumer_view_profile);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                nameOfPerson= dataSnapshot.child("Consumer").child(e2).child("name").getValue().toString();
                loca=dataSnapshot.child("Consumer").child(e2).child("city").getValue().toString();
                phoneOfPerson=dataSnapshot.child("Consumer").child(e2).child("phone").getValue().toString();
